  ...
  return (
    <ParallaxScrollView
      ...
      <Collapsible title="useEffect">
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise01'>Exercice 1</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise02'>Exercice 2</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise03'>Exercice 3</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise04'>Exercice 4</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise05'>Exercice 5</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise06'>Exercice 6</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise07'>Exercice 7</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffect/exercise08'>Exercice 8</Link>
      </Collapsible>
      ...
      <Collapsible title="useEffectEvent">
        <Link style={{ color: theme.colors.text }} href='/useeffectevent/exercise01'>Exercice 1</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffectevent/exercise02'>Exercice 2</Link>
        <Link style={{ color: theme.colors.text }} href='/useeffectevent/exercise03'>Exercice 3</Link>
      </Collapsible>
